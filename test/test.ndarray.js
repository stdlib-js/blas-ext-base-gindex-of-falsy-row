...
tape( 'the function has an arity of 6', function test( t ) {
	t.strictEqual( gindexOfFalsyRow.length, 6, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns an invalid index when M is less than or equal to zero (row-major)', function test( t ) {
	...
	var out = gindexOfFalsyRow( 0, data.N, data.A, data.strideA1, data.strideA2, data.offsetA );
...
tape( 'the function returns an invalid index when N is less than or equal to zero (row-major)', function test( t ) {
	var data = ROW_MAJOR_DATA;
	var out = gindexOfFalsyRow( data.M, 0, data.A, data.strideA1, data.strideA2, data.offsetA );
	t.strictEqual( out, -1, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major)', function test( t ) {
	var data = ROW_MAJOR_DATA;
	var out = gindexOfFalsyRow( data.M, data.N, data.A, data.strideA1, data.strideA2, data.offsetA );
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, offsets)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, offsets)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (row-major, offsets)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (column-major, offsets)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, mixed strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, mixed strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (row-major, mixed strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (column-major, mixed strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, negative strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, negative strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (row-major, negative strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (column-major, negative strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, large strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, large strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (row-major, large strides)', function test( t ) {
...
tape( 'the function returns an invalid index if unable to find a row in which all elements are falsy (column-major, large strides)', function test( t ) {
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, accessors)', function test( t ) {
	...
	out = gindexOfFalsyRow( data.M, data.N, A, data.strideA1, data.strideA2, data.offsetA );
	t.strictEqual( out, data.expected, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, offsets, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, offsets, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, negative strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, negative strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, mixed strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, mixed strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (row-major, large strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function returns the index of the first row in which all elements are falsy (column-major, large strides, accessors)', function test( t ) {
	var data;
	var out;
	var A;
...
tape( 'the function treats NaN as falsy (row-major)', function test( t ) {
	...
	out = gindexOfFalsyRow( 2, 2, data, 2, 1, 0 );
...
tape( 'the function treats NaN as falsy (column-major)', function test( t ) {
	...
	out = gindexOfFalsyRow( 2, 2, data, 1, 2, 0 );
	t.strictEqual( out, 0, 'returns expected value' );
	t.end();
});
